/*
 * NEOGEO Tournament Mode LED Configuration
 * Single player only — green when connected, idle when not.
 */
...
#define NEOPIXEL_PATTERN_0 pattern_greens   // idle — slow green pulse
#define NEOPIXEL_PATTERN_1 pattern_green    // connected — solid green
