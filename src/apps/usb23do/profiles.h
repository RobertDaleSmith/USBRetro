...
static const button_map_entry_t tdo_default_map[] = {
    ...
    MAP_BUTTON(USBR_BUTTON_B1, TDO_BUTTON_B),      // Cross/B → 3DO B (middle)
    MAP_BUTTON(USBR_BUTTON_B2, TDO_BUTTON_C),      // Circle/A → 3DO C (bottom)
    MAP_BUTTON(USBR_BUTTON_B3, TDO_BUTTON_A),      // Square/X → 3DO A (top)
    MAP_DISABLED(USBR_BUTTON_B4),                   // Triangle/Y → nothing

    // Shoulders - both L1/L2 map to L, both R1/R2 map to R
    MAP_BUTTON(USBR_BUTTON_L1, TDO_BUTTON_L),
    MAP_BUTTON(USBR_BUTTON_L2, TDO_BUTTON_L),
    MAP_BUTTON(USBR_BUTTON_R1, TDO_BUTTON_R),
    MAP_BUTTON(USBR_BUTTON_R2, TDO_BUTTON_R),

    // System
    MAP_BUTTON(USBR_BUTTON_S1, TDO_BUTTON_X),      // Select → X (Stop)
    MAP_BUTTON(USBR_BUTTON_S2, TDO_BUTTON_P),      // Start → P (Play)
};
...
static const button_map_entry_t tdo_fighting_map[] = {
    ...
    MAP_BUTTON(USBR_BUTTON_B1, TDO_BUTTON_B),      // Light Punch
    MAP_BUTTON(USBR_BUTTON_B2, TDO_BUTTON_C),      // Medium Punch
    MAP_BUTTON(USBR_BUTTON_B3, TDO_BUTTON_A),      // Heavy Punch
    MAP_BUTTON(USBR_BUTTON_B4, TDO_BUTTON_P),      // Light Kick

    // Shoulders - Medium/Heavy Kick
    MAP_BUTTON(USBR_BUTTON_L1, TDO_BUTTON_L),      // Medium Kick
    MAP_BUTTON(USBR_BUTTON_L2, TDO_BUTTON_R),      // Cross-mapped
    MAP_BUTTON(USBR_BUTTON_R1, TDO_BUTTON_R),      // Heavy Kick
    MAP_BUTTON(USBR_BUTTON_R2, TDO_BUTTON_L),      // Cross-mapped

    // System
    MAP_BUTTON(USBR_BUTTON_S1, TDO_BUTTON_X),
    MAP_BUTTON(USBR_BUTTON_S2, TDO_BUTTON_P),
};
...
static const button_map_entry_t tdo_shooter_map[] = {
    // Face buttons
    MAP_BUTTON(USBR_BUTTON_B1, TDO_BUTTON_C),      // Jump
    MAP_BUTTON(USBR_BUTTON_B2, TDO_BUTTON_B),      // Action
    MAP_BUTTON(USBR_BUTTON_B3, TDO_BUTTON_A),      // Weapon Switch
    MAP_BUTTON(USBR_BUTTON_B4, TDO_BUTTON_X),      // Special

    // Shoulders - Primary/Secondary Fire
    MAP_BUTTON(USBR_BUTTON_L1, TDO_BUTTON_L),      // Primary Fire
    MAP_BUTTON(USBR_BUTTON_L2, TDO_BUTTON_L),      // Primary Fire (OR)
    MAP_BUTTON(USBR_BUTTON_R1, TDO_BUTTON_R),      // Secondary Fire
    MAP_BUTTON(USBR_BUTTON_R2, TDO_BUTTON_R),      // Secondary Fire (OR)

    // System
    MAP_DISABLED(USBR_BUTTON_S1),                   // Unused
    MAP_BUTTON(USBR_BUTTON_S2, TDO_BUTTON_P),      // Pause
};
